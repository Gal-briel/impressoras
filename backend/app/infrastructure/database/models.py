...
class Agent(Base, TimestampMixin, SoftDeleteMixin):
    ...
    grouping_source: Mapped[str] = mapped_column(String(50), default="unknown")
    grouping_status: Mapped[str] = mapped_column(String(50), default="unassigned")
    group: Mapped[Optional["AgentGroup"]] = relationship("AgentGroup", viewonly=True)
