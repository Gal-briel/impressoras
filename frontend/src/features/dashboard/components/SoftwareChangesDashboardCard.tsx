...
export function SoftwareChangesDashboardCard() {
      ...
      <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
        <div>
          <h2 className="text-lg font-semibold text-slate-950">
            Mudanças recentes de software
          </h2>
          <p className="mt-1 text-sm text-slate-500">
            Comparação da última coleta de software de cada agente com a coleta anterior.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          {changes.length === 0 ? (
            <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-800">
              Nenhuma mudança ativa de software encontrada entre as últimas coletas.
            </div>
          ) : (
                ...
                <table className="min-w-full divide-y divide-slate-200 text-sm">
                  <thead className="bg-slate-50 text-xs uppercase tracking-wide text-slate-500">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left">Adicionados</th>
                      <th className="px-4 py-3 text-left">Removidos</th>
                      <th className="px-4 py-3 text-left">Alterados</th>
